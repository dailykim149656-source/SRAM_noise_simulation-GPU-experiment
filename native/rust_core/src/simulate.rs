...
fn perceptron_noise_weight(temperature: f64, voltage: f64) -> f64 {
    // Constants mirror spice_validation/calibration/perceptron_noise_weights.json.
...
mod tests {
    ...
    #[test]
    fn perceptron_noise_weight_matches_calibrated_mlp_center_point() {
        let weight = perceptron_noise_weight(330.0, 0.9);

        assert!((weight - 0.800_748_380_167_365_7).abs() < 1e-12);
    }
}
